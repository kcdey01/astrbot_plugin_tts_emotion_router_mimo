...
from .constants import (
    ...
    DEFAULT_MINIMAX_VOL,
    DEFAULT_MIMO_CLONE_AUDIO_PATH,
    DEFAULT_MIMO_FORMAT,
    DEFAULT_MIMO_MODEL,
    DEFAULT_MIMO_OPTIMIZE_TEXT_PREVIEW,
    DEFAULT_MIMO_SAMPLE_RATE,
    DEFAULT_MIMO_SINGING_MODE,
    DEFAULT_MIMO_STYLE_INSTRUCTION,
    DEFAULT_MIMO_URL,
    DEFAULT_MIMO_VOICE_DESCRIPTION,
...
class ConfigManager:
    ...
    def _ensure_defaults(self) -> None:
        ...
        mi_defaults = {
            ...
            "voice_description": DEFAULT_MIMO_VOICE_DESCRIPTION,
            "optimize_text_preview": DEFAULT_MIMO_OPTIMIZE_TEXT_PREVIEW,
            "clone_audio_path": DEFAULT_MIMO_CLONE_AUDIO_PATH,
            "speed": DEFAULT_API_SPEED,
            "emotion": "neutral",
            "style_instruction": DEFAULT_MIMO_STYLE_INSTRUCTION,
            "singing_mode": DEFAULT_MIMO_SINGING_MODE,
    ...
    def get_api_config(self) -> Dict[str, Any]:
        ...
        if provider == "mimo":
            ...
            return {
                ...
                "voice_description": str(mi.get("voice_description", DEFAULT_MIMO_VOICE_DESCRIPTION) or "").strip(),
                "optimize_text_preview": bool(mi.get("optimize_text_preview", DEFAULT_MIMO_OPTIMIZE_TEXT_PREVIEW)),
                "clone_audio_path": str(mi.get("clone_audio_path", DEFAULT_MIMO_CLONE_AUDIO_PATH) or "").strip(),
                "speed": _safe_float(mi.get("speed"), DEFAULT_API_SPEED),
                "emotion": str(mi.get("emotion", "neutral")),
                "style_instruction": str(mi.get("style_instruction", DEFAULT_MIMO_STYLE_INSTRUCTION) or "").strip(),
                "singing_mode": bool(mi.get("singing_mode", DEFAULT_MIMO_SINGING_MODE)),
